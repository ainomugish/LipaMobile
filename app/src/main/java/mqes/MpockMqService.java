...
//    This has been replaced by Student Charge of the RFActivity onEvent(StudentCharge)
//    Since we are replacing Mqtt for short distance device communication
//
//    //PUBLISH ON NEW STUDENT CHARGE
//    @Subscribe
...
//        sampleClient.state = 1;
//        try {
//           // log("going to publish to:"+Globals.PARTNER_KEYPAD + "/"+Globals.NEW_STUDENT_CHARGE);
//            log("going to publish to:"+Globals.appName+"/"+partnerDeviceName + "/"+Globals.NEW_STUDENT_CHARGE);
//            sampleClient.publish(Globals.appName + "/" + partnerDeviceName + "/" + Globals.NEW_STUDENT_CHARGE, 2, studentCharge.toString().getBytes(), studentCharge.toString());
...
//
//    This has been replaced by StudentChargeFinished event listener in the RFActivity
//    Since we are replacing Mqtt for short distance device communication
//
//    @Subscribe
...
//        try {
//            // log("going to publish to:"+Globals.PARTNER_KEYPAD + "/"+Globals.NEW_STUDENT_CHARGE);
//            log("going to publish to:"+Globals.appName+"/"+partnerDeviceName + "/"+Globals.STUDENT_CHARGE_FINISHED);
//            sampleClient.publish(Globals.appName + "/" + partnerDeviceName + "/" + Globals.STUDENT_CHARGE_FINISHED, 2, studentChargeFinished.toString().getBytes(), studentChargeFinished.toString());
//        } catch (Throwable throwable) {
//            throwable.printStackTrace();
//        }
//    }
